...
#ifdef OS_WIN_STORE
const WCHAR AppUserModelIdBase[] = L"190x4.TG190x4Desktop.Store";
#else // OS_WIN_STORE
const WCHAR AppUserModelIdBase[] = L"190x4.TG190x4Desktop";
#endif // OS_WIN_STORE
...
void CleanupShortcut() {
	...
	QString path = systemShortcutPath() + u"TG190x4.lnk"_q;
...
bool checkInstalled(QString path = {}) {
	...
	const auto installed = u"TG 190x4 EDITION/TG190x4.lnk"_q;
	const auto old = u"TG 190x4 for Windows/TG190x4.lnk"_q;
